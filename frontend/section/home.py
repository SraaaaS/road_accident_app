...
def app():
    st.markdown("<p style='color:#348781; font-size:36px; font-weight:bold'>Bienvenue sur la page d'accueil de l'application Road Accident Analysis", unsafe_allow_html=True)
