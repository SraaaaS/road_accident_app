...
def app():
    st.markdown("<p style='color:#348781; font-size:34px; font-weight:bold'>Bienvenue sur la page d'accueil de l'application Road Accident Analysis", unsafe_allow_html=True)
    ...
    st.caption("Image illustrative de la competition <span style='font-weight:italic'>Playground Series - Season 5, Episode 10 sur Kaggle<\span>",  )
